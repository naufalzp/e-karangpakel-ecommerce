...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#pesanan-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Pesanan</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="pesanan-nav" class="nav-content collapse  show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="#" class="active">
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <a href="export.php" class="btn btn-success"><i class="bi bi-box-arrow-up"></i> Export</a>
