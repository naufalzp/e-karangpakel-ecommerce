  ...
  <main id="main" class="main">
    ...
    <div class="form-floating mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="form-floating mb-3">
                      <input id="kategori" type="text" class="form-control" name="ctg_berita" >
              ...
              if (isset($_POST['buat'])) {
                ...
                $edit=  mysqli_query($conn, "INSERT INTO berita SET name_berita='$name_berita',ctg_berita='$ctg',isi_berita='$isi',foto_berita='$foto'");
                if($edit){
